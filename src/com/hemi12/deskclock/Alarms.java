...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "com.hemi12.deskclock.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "com.hemi12.deskclock.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "com.hemi12.deskclock.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "com.hemi12.deskclock.ALARM_DISMISS";
